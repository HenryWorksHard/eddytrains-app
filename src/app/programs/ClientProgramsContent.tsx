                        ...
                        {group.workouts.map((workout) => (
                          <div key={workout.id} className="space-y-1">
                            ...
                            <Link
                              ...
                              className="block bg-theme-card border border-zinc-800 hover:border-yellow-400/50 rounded-xl p-4 transition-colors touch-feedback"
                            >
                              <div className="flex items-center gap-3">
                                <div className="flex-1 min-w-0">
                                  <p className="text-theme-primary font-medium">{workout.name}</p>
                                </div>
                            ...
                            {workout.finisher && (
                              <Link
                                ...
                                className="block ml-4 bg-theme-surface border border-zinc-700 hover:border-orange-400/50 rounded-lg p-3 transition-colors touch-feedback"
                              >
                                <div className="flex items-center gap-2">
                                  <div className="w-6 h-6 rounded bg-orange-500/20 flex items-center justify-center">
                                    <span className="text-orange-400 text-xs font-bold">F</span>
                                  </div>
                                  <p className="text-theme-secondary text-sm font-medium">{workout.finisher.name}</p>
