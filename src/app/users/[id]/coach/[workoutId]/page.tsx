        ...
        <div className="space-y-4">
                  ...
                  <div className="px-4 pb-4 border-t border-zinc-800">
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full mt-1 px-3 py-2 bg-zinc-900 border border-zinc-700 rounded-lg text-foreground text-center font-bold focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                />
                    ...
                    {!isComplete && (
                      <button
                        ...
                        className="w-full mt-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-white font-medium rounded-xl transition-colors flex items-center justify-center gap-2 touch-feedback"
                      >
          ...
          <div className="card p-4">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-foreground placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-green-500 hover:bg-green-600 disabled:bg-zinc-800 disabled:text-zinc-500 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 touch-feedback tap-target"
          >
            {saving ? (
